...
2. `values`, which is an array of function names to call on the values within the provided range. It defaults to `['min','average','max']`. Functions such as `variance` and `stdev` can be added.
