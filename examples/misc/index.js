...
hc.Cell("Test35","=product([[9, 5], [6, 1]], [[3, 2], [5, 2]])",{oncalculated:cell => console.log("Test35",JSON.stringify(cell.value))});
...
hc.Cell("Test41","=remainder([1,2,3],1)",{oncalculated:cell => console.log("Test41",JSON.stringify(cell.value),[0,1,2])});
hc.Cell("Test42","=remainder([1,2,3],[1,2,3])",{oncalculated:cell => console.log("Test42",JSON.stringify(cell.value),[0,0,0])});
hc.Cell("Test43","=remainder([1,2,3],[1,2,3],1)",{oncalculated:cell => console.log("Test43",JSON.stringify(cell.value),[-1,-1,-1])});
